...
from bioflow.runtime.artifacts import RuntimeArtifact, ensure_dir_artifact, write_text_artifact
from bioflow.runtime.command_runner import DryRunCommandRunner, conda_command
from bioflow.runtime.fixture_validation import QuickstartFixture
from bioflow.runtime.report import report_markdown
...
class ComfyBIOReportNodeRuntime:
    ...
    def run(self, output_dir: Path, runner: DryRunCommandRunner) -> RuntimeArtifact:
        ...
        if _is_dry_run(record):
            write_text_artifact(report_path, report_markdown(Path("../deseq2/results.csv"), Path("../plots")))
