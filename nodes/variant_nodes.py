...
from bioflow.runtime.environment import VARIANT_ANALYSIS_REQUIREMENTS
...
class VariantInputValidatorNode(_BaseVariantNode):
    ...
    def INPUT_TYPES(cls) -> dict:
        return {
            "required": {
                "fastq_dir": cls._string_input("engine/examples/fixtures/variant"),
                "reference_fasta": cls._string_input("engine/examples/fixtures/variant/reference.fasta"),
                "metadata_csv": cls._string_input("engine/examples/fixtures/variant/sample_metadata.csv"),
