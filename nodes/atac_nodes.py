...
from bioflow.runtime.environment import EPIGENOMICS_REQUIREMENTS
...
class AtacInputValidatorNode(_BaseComfyBIONode):
    ...
    def INPUT_TYPES(cls) -> dict:
        return {
            "required": {
                "fastq_dir": cls._string_input("engine/examples/fixtures/atac"),
                "reference_fasta": cls._string_input("engine/examples/fixtures/atac/reference.fasta"),
                "metadata_csv": cls._string_input("engine/examples/fixtures/atac/sample_metadata.csv"),
