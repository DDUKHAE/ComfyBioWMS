...
from bioflow.runtime.environment import METAGENOME_REQUIREMENTS
...
class MetagenomeInputValidatorNode(_BaseComfyBIONode):
    ...
    def INPUT_TYPES(cls) -> dict:
        return {
            "required": {
                "fastq_dir": cls._string_input("engine/examples/fixtures/metagenome"),
                "kraken2_db_dir": cls._string_input("engine/examples/fixtures/metagenome/kraken2_db"),
                "metadata_csv": cls._string_input("engine/examples/fixtures/metagenome/sample_metadata.csv"),
