...
| **ComfyBioflow**<br>**(본 연구)** | *Bioinformatics / PLOS Comp Bio*<br>(2026 목표) | **8대 핵심 도메인**<br>**(24개 세부 워크플로우)** | **40+ 표준 실행 노드** +<br>**20종 전문 출판 플로터** | **4개 공인 벤치마크 사례**<br>1. SEQC RNA-Seq + 실시간 DEG<br>2. PhiX174 바이러스 조립<br>3. ATAC-Seq 크로마틴 접근성<br>4. 메타게놈 미생물 군집 분석 |
...
## 3. ComfyBioflow 플랫폼 논문의 최적 구성 제안

위 문헌 조사를 바탕으로 ComfyBioflow 논문의 범위를 다음과 같이 완벽히 정립합니다:
