...
└──────────────────────────────────────┬──────────────────────────────────────┘
                                       ...
                                       ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│                 ComfyBioWMS Platform & Execution Substrate                 │
│                                                                             │
...
## 3. ComfyBioWMS의 6대 핵심 워크플로우 생성 스킬 (Core Agent Skills)

ComfyBioWMS 플랫폼은 최신 LLM들이 공통으로 활용할 수 있는 6대 선언적 워크플로우 생성 스킬셋을 표준 인터페이스로 제공합니다:
