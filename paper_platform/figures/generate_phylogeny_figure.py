"""
Script to generate publication-grade Figure: Node Phylogeny Tree of ComfyBioflow Ecosystem.
...
ax_tree.axis("off")
ax_tree.set_title("(a) Taxonomic Phylogeny of ComfyBioflow Node Ecosystem (157 Nodes)", 
