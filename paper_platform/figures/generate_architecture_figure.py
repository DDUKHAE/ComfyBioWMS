"""
Script to generate Figure 1: 3-Tier System Architecture & End-to-End Execution Dataflow of ComfyBioWMS.
...
# Title
ax.text(8.0, 10.5, "ComfyBioWMS: Three-Tier System Architecture & Dataflow Wiring", 
