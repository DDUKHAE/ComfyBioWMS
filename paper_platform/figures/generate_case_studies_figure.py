"""
Script to generate Figure 2: End-to-End Biological Case Studies & Visual Analytics for ComfyBioWMS.
...
ax_b.barh(y_pos - 0.15, values, height=0.3, label="ComfyBioWMS (SPAdes)", color="#2a9d8f", edgecolor="#1b625a")
